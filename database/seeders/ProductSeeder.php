    ...
    public function run(): void
    {
        \App\Models\Product::insert([
            ...
            [
                ...
                'category' => 'Desain',
                'original_price' => 769000,
                'aksespro_price' => 150000,
                'duration_days' => 365,
                'stock' => 50,
                'max_stock' => 50,
                'is_active' => true,
            ...
            [
                ...
                'max_stock' => 5,
                'is_active' => false,
                'description' => 'Akun sharing 1 device. Streaming film Marvel, Disney, Pixar.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'max_stock' => 15,
                'is_active' => true,
                'description' => 'Akun sharing bergaransi. Cocok untuk mahasiswa menyusun skripsi.',
                'created_at' => now(),
                'updated_at' => now(),
            ]
        ]);
