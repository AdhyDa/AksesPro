        ...
        <>
            ...
            <section id="trust" className="bg-white py-16 lg:py-20 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="text-center mb-10 reveal">
                        <p className="text-navy/70 text-sm font-semibold uppercase tracking-widest mb-3">Platform yang kami dukung</p>
                        ...
                        <div className="marquee-track py-4">
                            ...
                            <div className="flex gap-6 items-center">
                                {uniqueProducts.map((product, idx) => {
                                    ...
                                    return (
                                        <div key={`s1-${idx}`}
                                            className={`trust-badge flex items-center gap-3 ${brand.bgClass} border ${brand.borderClass} rounded-2xl px-6 py-4 min-w-max shadow-md`}>
            ...
            <section id="produk" className="bg-[#0A2540] py-20 lg:py-28 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="text-center mb-16 reveal">
                        <div className="section-label text-cyan-accent mb-4">
            ...
            <section id="kontak" className="bg-[#0A2540] py-20 lg:py-28 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 text-center">
                    <div className="reveal">
                        <div className="section-label text-cyan-accent mb-6 mx-auto">
