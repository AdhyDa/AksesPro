<x-guest-layout>
    <div class="min-h-screen flex" x-data="{ isStudentMode: false }">
        ...
        <div class="hidden lg:flex w-1/2 bg-[#1A3147] flex-col justify-center items-center relative overflow-hidden"
            ...
            <div class="relative z-10 text-center">
                <img src="{{ asset('image/mockup.png') }}" alt="AksesPro Preview"
                    class="w-full max-w-md mx-auto drop-shadow-2xl mb-8 transform transition hover:scale-105 duration-500">
            ...
            <!-- Overlay Gradient -->
            <div class="absolute inset-0 bg-gradient-to-t from-[#112233] to-transparent opacity-80 pointer-events-none">
            </div>
        </div>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    <div class="flex items-center justify-center gap-2">
                        <img src="{{ asset('Logo.png') }}" alt="AksesPro Logo" class="h-14"
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 mb-2 mt-4">Selamat Datang di AksesPro!</h2>
                    ...
                    <button type="button" id="btn-student-toggle" @click="isStudentMode = !isStudentMode"
                        ...
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-colors"
                                :class="isStudentMode ? 'text-blue-600' : 'text-gray-700'">
                        ...
                        <span class="text-[10px]" :class="isStudentMode ? 'text-blue-500' : 'text-gray-400'">Dapatkan
                            bonus +100 poin</span>
                    </button>
                </div>
