...
@section('content')
    <!-- ============================================================
        ...
        ============================================================ -->
    <section id="hero"
        class="relative min-h-screen bg-hero-gradient flex items-center overflow-hidden hero-noise grid-bg">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-cyan-glow pointer-events-none"
            style="background: radial-gradient(ellipse, rgba(0,229,255,0.07) 0%, transparent 70%);"></div>

        <div
            class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 lg:py-0 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">

            <!-- Left: Copy -->
            <div class="text-center lg:text-left">
                <!-- Headline -->
                <h1
                    class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.08] tracking-tight text-white mb-6 pt-14">
                    Kerja Pro,<br />
                ...
                <p class="text-white/65 text-lg lg:text-xl leading-relaxed max-w-lg mx-auto lg:mx-0 mb-10">
                    ...
                    hemat hingga <strong class="text-cyan-accent font-semibold">88%</strong> dari harga resmi.
                </p>
                ...
                <div class="flex items-center justify-center lg:justify-start gap-3 sm:gap-4 pb-6">
                    <div class="text-center rounded-2xl px-5 py-3"
                        style="background: rgba(10,37,64,0.65); backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.15);">
                    ...
                    <div class="text-center rounded-2xl px-5 py-3"
                        style="background: rgba(0,229,255,0.12); backdrop-filter: blur(12px); border: 1px solid rgba(0,229,255,0.3);">
                        <div class="text-2xl font-bold text-cyan-accent">88%</div>
            ...
            <div class="hidden lg:flex items-center justify-center relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="w-80 h-80 rounded-full border border-cyan-accent/15 animate-ping"
                ...
                <div class="absolute w-72 h-72 rounded-full pointer-events-none"
                    style="background: radial-gradient(ellipse, rgba(0,229,255,0.12) 0%, transparent 70%);"></div>

                <!-- Maskot container -->
                <div class="relative animate-float z-10">
                    <img src="{{ asset('Maskot.png') }}"
                    ...
                    <div class="absolute top-6 -right-4 bg-cyan-accent font-bold text-xs px-3 py-1.5 rounded-full shadow-lg animate-float"
                        style="color:#0A2540; animation-delay: -1s;">
                        ⚡ Instan
                    </div>

                    <!-- Floating notification card -->
                    <div class="absolute -bottom-4 -left-8 bg-navy-800/90 backdrop-blur-xl border border-white/10 rounded-2xl p-3 flex items-center gap-3 animate-float"
                        style="animation-delay: -2s; background: rgba(13,46,89,0.92);">
                        <div
                            class="w-8 h-8 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 text-sm flex-shrink-0">
                            ✓</div>
                        <div>
                    ...
                    <div class="absolute top-1/2 -left-10 -translate-y-1/2 bg-[#0A2540]/90 backdrop-blur-xl border border-cyan-accent/20 rounded-2xl p-3 animate-float"
                        style="animation-delay: -3s;">
                        <div class="text-white/40 text-xs mb-0.5">Hemat hingga</div>
                        <div class="text-cyan-accent font-bold text-lg leading-none">88%</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="trust" class="bg-white py-16 lg:py-20 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="text-center mb-10 reveal">
                ...
                <h2 class="text-2xl lg:text-3xl font-bold text-navy">40+ Aplikasi Premium Tersedia</h2>
            </div>
                        ...
                        @foreach ($uniqueProducts as $item)
                            @php
                                ...
                                if (str_contains($pName, 'netflix')) {
                                    ...
                                    $fontStyle =
                                        "font-family: 'Impact', 'Arial Black', sans-serif; letter-spacing: -1px; font-weight: 900; text-shadow: 0 0 12px rgba(229, 9, 20, 0.55);";
                                    ...
                                    $fontStyle =
                                        "font-family: 'Circular', 'Inter', sans-serif; font-weight: 800; letter-spacing: -0.5px; text-shadow: 0 0 10px rgba(29, 185, 84, 0.4);";
                                    ...
                                    $fontStyle =
                                        "font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 700; text-shadow: 0 0 10px rgba(0, 196, 204, 0.4);";
                                    ...
                                    $fontStyle =
                                        "font-family: 'Inter', sans-serif; font-weight: 800; text-shadow: 0 0 10px rgba(0, 240, 255, 0.4);";
                                    ...
                                    $fontStyle =
                                        'font-family: monospace; font-weight: 700; text-shadow: 0 0 10px rgba(16, 163, 127, 0.4);';
                                    ...
                                    $fontStyle =
                                        "font-family: 'Oswald', 'Arial Black', sans-serif; font-weight: 900; letter-spacing: -0.8px; text-shadow: 0 0 10px rgba(255, 0, 0, 0.4);";
                                    ...
                                    $fontStyle =
                                        'font-family: -apple-system, BlinkMacSystemFont, sans-serif; font-weight: 700; text-shadow: 0 0 10px rgba(250, 36, 60, 0.4);';
                                    ...
                                    $fontStyle =
                                        "font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; text-shadow: 0 0 10px rgba(0, 174, 236, 0.4);";
                                    ...
                                    $fontStyle =
                                        "font-family: 'Helvetica Neue', Arial, sans-serif; font-weight: 900; font-style: italic; text-shadow: 0 0 10px rgba(0, 255, 102, 0.4);";
                                    ...
                                    $fontStyle =
                                        "font-family: 'Futura', sans-serif; font-weight: 700; text-shadow: 0 0 10px rgba(255, 77, 77, 0.4);";
                                    ...
                                    $fontStyle =
                                        "font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; text-shadow: 0 0 10px rgba(255, 204, 0, 0.4);";
                                    ...
                                    $fontStyle =
                                        "font-family: 'Montserrat', sans-serif; font-weight: 800; text-shadow: 0 0 10px rgba(255, 92, 0, 0.4);";
                                    ...
                                    $fontStyle =
                                        'font-family: sans-serif; font-weight: 800; text-shadow: 0 0 10px rgba(45, 140, 255, 0.4);';
                                } else {
                                    $brandName = $item->name;
                            ...
                            <div
                                class="trust-badge flex items-center gap-3 {{ $bgClass }} border {{ $borderClass }} rounded-2xl px-6 py-4 min-w-max shadow-md transition-transform duration-300">
                                <img src="{{ asset($logo) }}" alt="{{ $brandName }}"
                                    class="h-10 w-auto object-contain rounded-lg">
                                <span class="{{ $textClass }} text-xl font-bold"
                                    style="{{ $fontStyle }}">{{ $brandName }}</span>
                            </div>
                        @endforeach
                    </div>
    ...
    <section id="kenapa-kami" class="bg-[#F8F9FA] py-20 lg:py-28 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div class="text-center mb-16 reveal">
                <div class="section-label text-navy mb-4"
                    style="background: rgba(10,37,64,0.07); border-color: rgba(10,37,64,0.15);">
                ...
                <p class="text-navy/55 text-lg max-w-2xl mx-auto">
                    Kami bukan sekadar penjual akun. Kami adalah platform teknologi yang membangun ekosistem berlangganan
            ...
            <div class="grid md:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div
                    class="pillar-card reveal reveal-delay-1 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm relative overflow-hidden">
                    <!-- Accent corner -->
                    ...
                    <!-- Number -->
                    <div class="text-cyan-accent/20 font-black text-7xl absolute top-6 right-8 leading-none select-none">01
                    </div>
                    ...
                    <p class="text-navy/55 leading-relaxed text-sm">
                        ...
                        <strong class="text-navy/80">Tanpa nunggu admin balas chat</strong>, 24 jam sehari, 7 hari
                        seminggu.
                    </p>
                    ...
                    <div class="flex flex-wrap gap-2 mt-6">
                        <span
                            class="text-xs bg-cyan-accent/10 text-cyan-accent border border-cyan-accent/20 rounded-full px-3 py-1 font-medium">⚡
                            QRIS</span>
                        <span
                            class="text-xs bg-cyan-accent/10 text-cyan-accent border border-cyan-accent/20 rounded-full px-3 py-1 font-medium">⚡
                            E-Wallet</span>
                ...
                <div class="pillar-card reveal reveal-delay-2 bg-[#0A2540] rounded-3xl p-8 relative overflow-hidden shadow-2xl"
                    style="box-shadow: 0 20px 60px rgba(10,37,64,0.3), 0 0 40px rgba(0,229,255,0.1);">
                    <!-- Glow overlay -->
                    ...
                    <!-- Icon -->
                    <div
                        class="w-14 h-14 rounded-2xl bg-cyan-accent/20 flex items-center justify-center mb-6 border border-cyan-accent/30">
                        <svg class="w-7 h-7 text-cyan-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-white/60 leading-relaxed text-sm">
                        Akun bermasalah di tengah masa berlangganan? <strong class="text-white/90">Kami ganti baru tanpa
                            biaya tambahan</strong>. Bebas khawatir, tidur tenang.
                    </p>

                    <!-- Feature pills -->
                    <div class="flex flex-wrap gap-2 mt-6">
                        <span
                            class="text-xs bg-white/10 text-white/80 border border-white/20 rounded-full px-3 py-1 font-medium">🛡
                            Ganti Akun</span>
                        <span
                            class="text-xs bg-white/10 text-white/80 border border-white/20 rounded-full px-3 py-1 font-medium">🛡
                            Tanpa Biaya</span>
                ...
                <div
                    class="pillar-card reveal reveal-delay-3 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm relative overflow-hidden">
                    ...
                    <p class="text-navy/55 leading-relaxed text-sm">
                        Tanpa biaya tersembunyi. Patungan resmi, legalitas terjaga. Hemat hingga <strong
                            class="text-navy/80">88% dari harga resmi</strong> — dompet tetap aman, produktivitas tetap
                        maksimal.
                    </p>
                    ...
                    <div class="flex flex-wrap gap-2 mt-6">
                        <span
                            class="text-xs bg-[#0A2540]/5 text-[#0A2540]/70 border border-navy/10 rounded-full px-3 py-1 font-medium">💰
                            Transparan</span>
                        <span
                            class="text-xs bg-[#0A2540]/5 text-[#0A2540]/70 border border-navy/10 rounded-full px-3 py-1 font-medium">💰
                            Legal</span>
    ...
    <section id="produk" class="bg-[#0A2540] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
                <x-product-card delay="1" bgClasses="bg-gradient-to-br from-navy-800 to-navy"
                    bgStyle="background: linear-gradient(135deg, #0d2e59 0%, #0A2540 100%);"
                    iconBg="background: linear-gradient(135deg, #7c3aed, #a855f7);" title="Canva Pro"
                    subtitle="Design & Kreativitas" badgeText="PRO"
                    badgeClasses="bg-purple-500/20 text-purple-400 border border-purple-500/30" :features="[
                        'Semua template premium (+ 610K+)',
                        'Background Remover & Magic Resize',
                        'Brand Kit & Logo personalisation',
                        '100 GB cloud storage',
                    ]"
                    featureIconBg="bg-purple-500/20" featureIconColor="text-purple-400" priceOriginal="Rp 120.000"
                    priceDiscounted="Rp 19.000" discountPercent="84%"
                    discountClasses="bg-emerald-500/15 text-emerald-400 border border-emerald-500/25"
                    buyUrl="{{ route('user.katalog.detail', 'canva-pro-1-tahun') }}" buyBtnClasses="btn-primary">
                    <x-slot:icon>
                        <img src="{{ asset('image/canva.jpg') }}" alt="Canva Pro"
                            class="w-full h-full object-cover rounded-2xl" />
                    </x-slot:icon>
                </x-product-card>

                <x-product-card delay="2" :isFeatured="true" bgClasses=""
                    ...
                    iconBg="background: #1DB954;" title="Spotify Premium" subtitle="Musik & Podcast" badgeText="PREMIUM"
                    badgeClasses="bg-[#1DB954]/20 text-[#1DB954] border border-[#1DB954]/40" :features="[
                        '80+ juta lagu tanpa iklan',
                        'Download & putar offline',
                        'Kualitas audio HD (320 kbps)',
                        'Podcast premium eksklusif',
                    ]"
                    featureIconBg="bg-[#1DB954]/20" featureIconColor="text-[#1DB954]" priceOriginal="Rp 54.990"
                    priceDiscounted="Rp 10.000" priceDiscountedClasses="text-cyan-accent text-glow" discountPercent="81%"
                    ...
                    <x-slot:icon>
                        <img src="{{ asset('image/spotify.jpg') }}" alt="Spotify Premium"
                            class="w-full h-full object-cover rounded-2xl" />
                    </x-slot:icon>
                </x-product-card>

                <x-product-card delay="3" bgClasses="bg-gradient-to-br"
                    bgStyle="background: linear-gradient(135deg, #1a0000 0%, #2d0000 50%, #1a0000 100%);"
                    iconBg="background: #E50914;" title="Netflix Premium" subtitle="Streaming & Hiburan"
                    badgeText="4K UHD" badgeClasses="bg-red-500/20 text-red-400 border border-red-500/30"
                    :features="[
                        'Streaming 4K Ultra HD + HDR',
                        'Akses semua film & series terbaru',
                        'Download konten untuk offline',
                        'Profil pribadi (privacy terjaga)',
                    ]" featureIconBg="bg-red-500/20" featureIconColor="text-red-400"
                    priceOriginal="Rp 186.000" priceDiscounted="Rp 29.000" discountPercent="84%"
                    ...
                    <x-slot:icon>
                        <img src="{{ asset('image/netflix.jpg') }}" alt="Netflix Premium"
                            class="w-full h-full object-cover rounded-2xl" />
                    </x-slot:icon>
                    <x-slot:bgGlow>
                        <div class="absolute inset-0 pointer-events-none"
    ...
    <section id="cara-kerja" class="bg-[#F8F9FA] py-20 lg:py-28">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div class="grid lg:grid-cols-3 gap-8 lg:gap-12 relative">
                ...
                <div
                    class="hidden lg:block absolute top-16 left-[calc(33.3%+1rem)] right-[calc(33.3%+1rem)] h-px border-t-2 border-dashed border-navy/15">
                </div>

                <!-- Step 1 -->
                <div class="reveal reveal-delay-1 text-center group">
                    <div class="relative inline-flex mb-6">
                        <div class="w-20 h-20 rounded-full bg-[#0A2540] text-white font-bold text-2xl flex items-center justify-center shadow-xl group-hover:scale-105 transition-transform duration-300 mx-auto"
                            style="box-shadow: 0 12px 40px rgba(10,37,64,0.3);">
                            01
                        </div>
                        <div
                            class="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-cyan-accent flex items-center justify-center">
                            <svg class="w-3 h-3 text-navy font-bold" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                    ...
                    <p class="text-navy/55 text-sm leading-relaxed max-w-xs mx-auto">
                        Cari aplikasi premium yang kamu butuhkan dari katalog kami yang terus diperbarui. Pilih durasi
                ...
                <div class="reveal reveal-delay-2 text-center group">
                    <div class="relative inline-flex mb-6">
                        ...
                        <div
                            class="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-cyan-accent flex items-center justify-center">
                            <svg class="w-3 h-3 text-navy" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                    ...
                    <p class="text-navy/55 text-sm leading-relaxed max-w-xs mx-auto">
                        Gunakan QRIS atau e-wallet (GoPay, OVO, Dana, ShopeePay). Konfirmasi otomatis dalam hitungan detik
                ...
                <div class="reveal reveal-delay-3 text-center group">
                    ...
                    <p class="text-navy/55 text-sm leading-relaxed max-w-xs mx-auto">
                        Cek email atau dashboard untuk detail login dan langsung nikmati semua fitur premiumnya. Welcome to
                        the Pro club! 🎉
                    </p>
                </div>
            </div>
    ...
    <section class="bg-white py-16 lg:py-20 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="text-center mb-10 reveal">
                <h2 class="text-2xl lg:text-3xl font-bold text-navy mb-2">Kata Mereka yang Sudah<br class="sm:hidden" />
                    Bergabung</h2>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="reveal reveal-delay-1 bg-[#F8F9FA] rounded-2xl p-6 border border-gray-100">
                    ...
                    <p class="text-navy/70 text-sm leading-relaxed mb-4">
                        "Awalnya skeptis, tapi setelah bayar QRIS, login Canva Pro langsung masuk ke email dalam 30 detik.
                        Gila, ini yang saya cari selama ini!"
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-9 h-9 rounded-full bg-purple-100 flex items-center justify-center font-bold text-purple-600 text-sm">
                            R</div>
                        <div>
                ...
                <div class="reveal reveal-delay-2 bg-[#0A2540] rounded-2xl p-6 relative overflow-hidden">
                    ...
                    <p class="text-white/65 text-sm leading-relaxed mb-4 relative z-10">
                        "Udah 6 bulan langganan Spotify di sini. Pernah satu kali ada masalah akun, langsung diganti dalam 2
                        jam. Garansinya beneran!"
                    </p>
                    <div class="flex items-center gap-3 relative z-10">
                        <div
                            class="w-9 h-9 rounded-full bg-cyan-accent/20 flex items-center justify-center font-bold text-cyan-accent text-sm">
                            S</div>
                        <div>
                ...
                <div class="reveal reveal-delay-3 bg-[#F8F9FA] rounded-2xl p-6 border border-gray-100">
                    <div class="flex items-center gap-1 text-yellow-400 text-sm mb-3">★★★★★</div>
                    <p class="text-navy/70 text-sm leading-relaxed mb-4">
                        "Tim konten kami sekarang pakai Canva Pro + ChatGPT Plus dari AksesPro. Budget yang biasanya habis
                        Rp 400rb/bln cukup Rp 60rb. Efisiensinya luar biasa!"
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-9 h-9 rounded-full bg-blue-100 flex items-center justify-center font-bold text-blue-600 text-sm">
                            D</div>
                        <div>
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 text-center">
            ...
            <div class="reveal">
                ...
                <p class="text-white/55 text-lg max-w-2xl mx-auto mb-12 leading-relaxed">
                    Tim kami siap membantu memilihkan paket terbaik sesuai kebutuhanmu. Chat sekarang, respons dalam 5
                    menit.
                </p>
                ...
                <div class="grid sm:grid-cols-2 gap-4 max-w-xl mx-auto mb-12">
                    ...
                    <a href="https://api.whatsapp.com/send/?phone=62895396048445" target="_blank" rel="noopener"
                        ...
                        <div
                            class="w-12 h-12 rounded-xl bg-[#25D366]/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    ...
                    <a href="https://instagram.com/aksespro_id" target="_blank" rel="noopener" id="contact-ig"
                        ...
                        <div
                            class="w-12 h-12 rounded-xl bg-pink-500/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
