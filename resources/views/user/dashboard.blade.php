<x-dashboard>
    ...
    <div x-data="{ showCredential: false, activeCredName: '', activeCredEmail: '', activeCredPass: '' }" class="space-y-6">
        ...
        <!-- Greeting Banner -->
        <div
            class="bg-[#0A2540] rounded-2xl p-6 sm:p-10 relative overflow-hidden shadow-lg border border-[#0A2540]/50">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-white mb-2">Selamat datang kembali,
                        {{ $user['name'] }}! 👋</h1>
                    <p class="text-blue-100 text-sm sm:text-base max-w-xl">
                        Kelola langganan digital premium Anda, nikmati akses tanpa batas, dan kumpulkan poin untuk
                        ditukarkan dengan potongan harga menarik.
                    </p>
                </div>
                <div
                    class="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 flex items-center gap-4 shadow-inner min-w-[200px]">
                    <div class="w-12 h-12 rounded-full bg-[#00E5FF]/20 flex items-center justify-center">
                        <svg class="w-6 h-6 text-[#00E5FF]" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white">{{ number_format($user['points'], 0, ',', '.') }}<span
                                class="text-sm text-[#00E5FF] font-medium ml-2">Pts</span></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div
                class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-start gap-4 hover:shadow-md transition-shadow">
                <div
                    class="w-12 h-12 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center flex-shrink-0">
                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900">
                        {{ number_format($stats['points_collected'], 0, ',', '.') }}</h3>
                    <p class="text-green-500 text-xs font-medium mt-1 flex items-center gap-1">
                        <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M5 10l7-7m0 0l7 7m-7-7v18" />
                        ...
                        @foreach ($subscriptions as $sub)
                            <tr class="bg-white border-b hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 font-semibold text-gray-900 flex items-center gap-3">
                                    <div
                                        class="w-8 h-8 rounded bg-gray-100 flex items-center justify-center overflow-hidden">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2.5 py-1 bg-blue-50 text-blue-600 rounded-md text-xs font-semibold">{{ $sub['package'] }}</span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('user.katalog.detail', $sub['product_slug']) }}"
                                            class="p-2 text-gray-400 hover:text-[#00E5FF] hover:bg-[#00E5FF]/10 rounded-lg transition-colors inline-block"
                                            title="Perpanjang">
                                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
