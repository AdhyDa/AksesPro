        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-xl shadow-[#0A2540]/5 border border-gray-100 p-6 sticky top-6">
                    ...
                    <button class="w-full bg-[#0A2540] hover:bg-[#0d2e59] text-white py-3.5 rounded-xl font-bold text-lg transition-all transform hover:scale-[1.02] shadow-md flex items-center justify-center gap-2 {{ $product->stock <= 0 ? 'opacity-50 cursor-not-allowed hover:scale-100' : '' }}" {{ $product->stock <= 0 ? 'disabled' : '' }}>
