        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <div class="relative">
                    ...
                    <input type="text" class="bg-white border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-[#00E5FF] focus:border-[#00E5FF] block w-full pl-10 p-2.5" placeholder="Cari invoice...">
                </div>
                <button class="px-4 py-2.5 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <button class="p-2 text-gray-400 hover:text-[#0A2540] hover:bg-gray-100 rounded-lg transition-colors inline-flex items-center gap-2" title="Unduh Invoice">
